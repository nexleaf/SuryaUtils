...
/usr/bin/python2.6 -u $SURYA_DEPLOY_ROOT/SuryaIANAGmailPortal/src/GmailMonitor/IANAGmailMonitor.py -1 &> /dev/null &
GMM=$!

sleep 5

/usr/bin/python2.6 -u $SURYA_DEPLOY_ROOT/SuryaIANAFramework/src/IANA/IANAFramework.py -1 &> /dev/null &
SIF=$!

sleep 15

/usr/bin/python2.6 -u $SURYA_DEPLOY_ROOT/SuryaIANAGmailPortal/src/GmailResults/IANAGmailResults.py -1 &> /dev/null &
GMR=$!
